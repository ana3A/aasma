...
public class DataHolder : MonoBehaviour
{
    ...
    public void SendData(List<float> responseTimesList, List<int> peopleSavedList, List<int> peopleNotSavedList, List<int> allPeopleList, float maxRepTime, int maxPeopleSav, int maxPeopleNotSav, float runningTime)
    {
